            ...
            <FadeInView direction="left" className="lg:pt-2">
              <div className="mx-auto max-w-[320px] lg:mx-0">
                ...
                <div className="mt-6 text-center lg:text-left">
                  ...
                  <p className="mt-1 font-display text-sm font-semibold uppercase tracking-wide text-[#1E3A8A]">
                    Principal
                  </p>
                      ...
                      <div>
                        ...
                        <dd className="mt-1">
                          <a
                            ...
                            className="break-all font-medium text-[#1E3A8A] transition-colors hover:text-[#0B1F5B]"
                          >
                            {p.email}
                          </a>
                        </dd>
